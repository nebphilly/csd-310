...
print("\n  -- INSERT STATEMENTS --")
print(
    "  Inserted student record into the students collection with document_id "
    + str(test_doc_id))
...
print("  Student ID: " + student_test_doc["student_id"] + "\n  First Name: " +
      student_test_doc["first_name"] + "\n  Last Name: " +
      student_test_doc["last_name"] + "\n")
...
'''
References
Krasso, R. (2020, July 13). CSD 310 Database Development and Use. Retrieved from GitHub:
